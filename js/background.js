...
const closeBgModal = () => {
  ...
  if (input.value.trim() !== '') {
    bgElem.style = `background: linear-gradient(120deg, #fccb9077 0%, #d57eeb91 100%), url(${link}); background-repeat: no-repeat; background-attachment: fixed; background-size: cover;`;
